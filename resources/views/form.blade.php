...
<div class="container">
    ...
    <div class="admin-product-form-container">
        ...
        <form  method="POST" action="/insertproducts" enctype="multipart/form-data">
            ...
            <input type="text" placeholder="Enter description" name="description" class="description" required>
            <input type="file" accept="image/png, image/jpeg, image/jpg" name="image_products" class="box" required>
            
            <div class="row">
                <div class="col text-center">
                    <input type="submit" class="btn btn-primary me-2" name="add_product" value="Add Product">
